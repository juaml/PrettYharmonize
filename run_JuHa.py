...
# H = JuHa()
# harm_data_ft = H.fit_transform(data, sites, target)
# harm_data_t = H.transform(data, sites, target)
# assert_array_equals(harm_data_ft, harm_data_t)
...
# # kfold objects
# kf_outer = KFold(n_splits=n_splits_out, shuffle=True,
...
#         data_pretend_inner = Hinner.transform_target_pretend(
#             data[idx_test_inner], sites[idx_test_inner])
...
#     data_pretend_outer = Houter.transform_target_pretend(
#         data[outer_test_index], sites[outer_test_index])
...
#     data_leak = Houter.transform(
#         data[outer_test_index], sites[outer_test_index], target[outer_test_index])
